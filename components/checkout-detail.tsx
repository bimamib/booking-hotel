  ...
  return (
    <div className="grid md:grid-cols-2 gap-5">
      <div className="order-2">
        <div className="flex flex-col mb-3 items-start bg-white border border-gray-200 rounded-lg md:flex-row md:w-full">
          <div className="aspect-video relative">
            <Image
              src={reservation.Room.image}
              width={500}
              height={300}
              className="object-cover w-full rounded-t-lg aspect-video md:rounded-none md:rounded-s-lg"
              alt="image"
            />
          </div>
          <div className="flex flex-col justify-between p-4 leading-normal w-full">
            <h5 className="mt-1 text-4xl font-bold tracking-tight text-gray-900">
      ...
      <div className="border border-gray-200 px-3 py-5 bg-white rounded-lg">
