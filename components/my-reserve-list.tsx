    ...
    <div>
      {reservation.map((item) => (
        <div
          ...
          key={item.id}
        >
          <div className="flex items-center justify-between bg-gray-100 px-2 py-1 rounded-t-xl">
          ...
          <div className="flex flex-col mb-4 items-start bg-white md:flex-row md:w-full">
            <Image
              ...
              width={500}
              height={300}
              className="object-cover w-full rounded-t-lg h-60 md:h-auto md:w-1/3 md:rounded-none md:rounded-s-lg"
              alt="image room"
            />
          ...
          <div className="flex items-end justify-end absolute inset-4">
            {item.Payment?.status === "unpaid" ? (
              <Link
                ...
                className="px-6 py-1 bg-orange-400 rounded-lg hover:bg-orange-500 text-white"
              >
                Pay Now
              </Link>
            ) : (
              <Link
                ...
                className="px-5 py-1 bg-orange-400 rounded-lg hover:bg-orange-500 text-white"
              >
                View Detail
              </Link>
            )}
